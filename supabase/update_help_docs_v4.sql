...
**📄 All Scripts** — everything else (Draft, Needs revision, Approved, Used in production, Archived). Has a status filter and a **🗑 delete button** per row.

**📊 Short Video Script Spreadsheet button** — opens the script tracking Google Sheet directly, routed to the correct month tab automatically. To update the spreadsheet URL for a new year, click the **⚙️** button next to it, paste the new URL, and save — no code change needed.

**Viewing a script:**
Click **View** to open the full script. You'll see:

- **Hook** — the first spoken line of the video (under 10 words). This is also literally the opening sentence of the voiceover — not a separate intro card.
...
- **Your notes for AI** — optional direction you type before regenerating (e.g. "make hook punchier", "shorten to 15s")
...
9. **Script is reviewed** — open it to see the hook, thumbnail title, and full voiceover. Run AI Brand Check if you want, choose a hook pattern, regenerate as needed. When ready, change status to **Approved**.

10. **You film it** — change the brief status to **Filming** when production starts. Use the **📊 Short Video Script Spreadsheet** button to open the tracking sheet for the current month.

11. **You log the published video** — go to **Published**, click **+ Add Video**.

12. **Performance is tracked** — 24h, 72h, 7-day checkpoints appear in Command Center.

13. **Learning is captured** — once measured, a learning goes to the **Learning** tab. Approved learnings feed into the next round of AI briefs and scripts.
