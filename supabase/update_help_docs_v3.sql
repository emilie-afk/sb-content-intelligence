...
- **🔬 Needs research** — sends the cluster back to Discovery for more signal; the card disappears from the "Ready for review" list and reappears in Discovery
...
**Viewing a script:**
Click **View** to open the full script. At the bottom you'll find:

- **Your notes for AI** — optional text you type before regenerating
...
- **✨ Regenerate Script** — generates a fresh new version using the hook pattern you selected. If you ran a brand check first, the new version fixes the flagged issues. If you haven't, it writes a genuinely different take (not a copy of the current script).
...
9. **Script is reviewed** — open it, run AI Brand Check if you want, choose a hook pattern, regenerate as needed. When it is ready, change status to **Approved**.

10. **You film it** — change the brief status to **Filming** when production starts.
